...
Once you have read this entire syllabus and [the assignments page](/assignments/), please [click here](mailto:aheiss@gsu.edu) and e-mail me a picture of a *cute* non-feline, non-canine animal. For real. Brownie points if it's animated. 

`r blogdown::shortcode("figure", src = "https://media.giphy.com/media/3xz2BCohVTd7h2Kvfi/giphy.gif", alt = "Floating hedgehog", lightbox = "false")`
