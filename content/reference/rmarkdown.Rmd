...
knitr::include_graphics("/img/reference/insert-chunk.png")
```
...
knitr::include_graphics("/img/reference/chunk-toc.png")
```
...
knitr::include_graphics("/img/reference/chunk-options.png")
```
...
knitr::include_graphics("/img/reference/output-options.png")
```
