...
You will submit one thing via iCollege:

1. A PDF of your preregistered report (**see the outline below for details of what this needs to contain**). You can compile this with R Markdown, or you can do it in a word processor like Word or Google Docs. If you use R Markdown, you might want to write the prose-heavy sections in a word processor and copy/paste the text into your R Markdown document, since RStudio doesn't have a nice spell checker or grammar checker.

This project is due by **7:00 PM on Wednesday, April 29, 2020.** <span style="color: #81056F; font-weight: bold"> No late work will be accepted.</span>
...
- ~~[<i class="fas fa-external-link-square-alt"></i> Empty RStudio.cloud project](https://rstudio.cloud/spaces/44864/project/1128916)~~
...
**Due to the COVID-19 pandemic, you do not have to do this section.**
