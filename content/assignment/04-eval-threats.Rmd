...
I've created an R Markdown template you can use here: [<i class="fas fa-file-archive"></i> `threats-validity.zip`](/projects/threats-validity.zip). It's also [available on RStudio.cloud](https://rstudio.cloud/spaces/44864/project/879490).
