...
You can find [a complete example of RDD analysis on the class page from Week 11](/class/11-class/). **This will be incredibly useful as a guide for completing this assignment.**
...
1. Open the project named "Problem Set 5" on RStudio.cloud. [This link should take you to the project](https://rstudio.cloud/spaces/44864/project/1087096)—if it doesn't, log in and look for the project named "Problem Set 5."

    Alternatively, if you're using R on your own computer, download this file, *unzip it*, and double click on the file named `problem-set-5.Rproj`: [<i class="fas fa-file-archive"></i> `problem-set-5.zip`](/projects/problem-set-5.zip)
